      ...
      <v-container fluid class="my-5">
        <v-card flat>
          <v-card-title class="d-flex align-center pe-2">
            <v-icon icon="view_list"></v-icon>&nbsp; Liste des employés
            <v-spacer></v-spacer>
            <v-text-field
              v-model="search"
          ...
          <v-data-table
            ...
            :headers="headers"
            :items="employes"
            :loading="employeLength > 0 ? false : true"
...
export default {
  setup() {
    ...
    return { authStore, employeStore, token, accessRights };
  },
  data: () => ({
    dialog: false,
    dialogDelete: false,
