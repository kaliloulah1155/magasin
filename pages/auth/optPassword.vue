                ...
                <v-row>
                  <v-col cols="12" sm="6">
                    <v-card-text class="mt-12">
                      <v-row class="text-center d-flex justify-center">
                        <v-col cols="12" sm="10">
                          <v-sheet class="py-8 px-6 mx-auto ma-4 text-center">
                            <h3 class="text-h5">Verification de Code</h3>

                            <div class="text-subtitle-2 font-weight-light mb-3">
                              Veuillez saisir le code de vérification envoyé sur
                              votre email
                            </div>
                    ...
                    <div style="text-align: center; padding: 180px 0">
                      <v-card-text class="text-white">
                        ...
                        <h3 class="text-center">
                          Décrouvrez les meilleurs fonctionnalités que offrent
                          <b>GLOBAL PLUS</b>
                        </h3>
                      </v-card-text>
                ...
                <v-row>
                  <v-col cols="12" sm="6" class="blue rounded-br-xl">
                    <div style="padding: 180px 0">
                      <v-card-text class="text-white">
                        ...
                        <br />
                        <h3 class="text-center">
                          Vous être sur le point de réinitialiser le mot de
                          passe
                        </h3>
                      </v-card-text>
                      <div class="text-center">
                  ...
                  <v-col cols="12" sm="6">
                    <v-card-text class="mt-12">
                      <v-card-text>
                        <h3 class="">
                          Une application de point de vente (POS) performante
                          avec des fonctionnalités robustes pour améliorer
                          l'efficacité
                        </h3>
                        <v-container>
                          <ul>
                            ...
                            <li>
                              Analyse des performances des produits et des
                              employés
                            </li>
                            <li>Gestion des retours et des échanges</li>
                            <li>
                              Gestion des commandes en ligne et des livraisons
                            </li>
                            <li>
                              Sauvegardes automatiques et sécurisées des données
                            </li>
                          </ul>
                        </v-container>
                      </v-card-text>
