    ...
    <v-container fluid class="my-5">
      <v-card flat>
        <v-card-title class="d-flex align-center pe-2">
          <v-icon icon="view_list"></v-icon>&nbsp; Liste des dépenses
          <v-spacer></v-spacer>
          <v-text-field
            v-model="search"
        ...
        <v-data-table
          ...
          :headers="headers"
          :items="depenses"
          :loading="depenseLength > 0 ? false : true"
          :sort-by="[{ key: 'detail', order: 'asc' }]"
          items-per-page="10"
        >
          <template v-slot:top>
            <v-spacer></v-spacer>
                ...
                <v-card-text>
                  <v-form class="px-3" ref="form">
                    ...
                    <v-text-field
                      ...
                      clearable
                      variant="outlined"
                      v-model="editedItem.date_depense"
                      :rules="[isDateValid]"
                    ></v-text-field>
                  </v-form>
                </v-card-text>
...
export default {
  setup() {
    ...
    return { authStore, depenseStore, token, accessRights };
  },
  data: () => ({
    dialog: false,
    dialogDelete: false,
